...
QUERY_URL_WEIGHT = "http://localhost:8983/solr/reviews/select?_=1668268291347&defType=edismax&fl=*+score&indent=true&q=health+manufacturing&q.op=AND&qf=name+industry%5E2+description%5E1.5&rows=10&start=0"
